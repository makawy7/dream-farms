                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/10.jpg)"></span>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/12.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        Flower Pot</h6>
                                                                </div>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/4.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        Pen Drive</h6>
                                                                </div>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/8.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        New Bowl</h6>
                                                                </div>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/6.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        Leather Watch</h6>
                                                                </div>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/1.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        Digital Camera</h6>
                                                                </div>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/11.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        Earphones</h6>
                                                                </div>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <span class="avatar bradius"
                                                                    style="background-image: url({{ asset('assets/admin') }}/images/orders/2.jpg)"></span>
                                                                <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold">
                                                                        Shoes</h6>
                                                                </div>
